...
interface AuthContextType {
  ...
  register: (payload: { name: string; email: string; dob: string; password: string }) => Promise<void>;
  logout: () => void;
  token: string | null;
}
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const register = useCallback(async (payload: { name: string; email: string; dob: string; password: string }) => {
    try {
